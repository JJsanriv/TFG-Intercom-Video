...
\begin{center}
	...
	\captionof{figure}{Estructura jerarquizada de \textit{InterCom}.}
	\label{fig:jeraquia}
\end{center}
...
\begin{ganttchart}[
    ...
    % Tarea 4: Memoria
    \ganttgroup{\textbf{Realización memoria proyecto}}{2025-05-01}{2025-06-02} \\
    \ganttbar[bar/.style={fill=blue!70}]{Estimado}{2025-05-01}{2025-05-31} \\
    \ganttbar[bar/.style={fill=red!70}]{Real}{2025-05-09}{2025-06-02} \\
    \ganttmilestone{Entrega proyecto}{2025-06-03} \\
\end{ganttchart}
