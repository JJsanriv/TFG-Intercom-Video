...
\begin{titlepage}
    ...
    \end{tabular}
    \vfill
    % Añadir tilde sobre la I de ALMERIA
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north] at ([xshift=547pt, yshift=730pt]current page.south west) {
            \fontsize{20pt}{22pt}\selectfont \textbf{\textasciiacute}
        };
    \end{tikzpicture}
    \begin{tikzpicture}[remember picture, overlay]
